...
public class MainModule {
    ...
    private static void registerCustomer() {
        ...
        Customer customer = new Customer(0, name, email, number, password);
            try{
                boolean success = customerService.createCustomer(customer);
                if(success){System.out.println("Customer registered successfully!");}
                else{System.out.println("Customer registered failed.");}
    ...
    private static void createRestaurant(){
        ...
        System.out.print("Restaurant created successfully!");
    }

    private static void createMenuItem(){
            System.out.print("Enter restaurant ID to add menu item: ");
            int restaurantId = scanner.nextInt();scanner.nextLine();
